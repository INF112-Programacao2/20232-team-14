...
namespace model {
    ...
    private:
        ...
        double _diaria_caminhao;        //Preço pago a cada dia que o veículo permanece no pátio
        double _reboque_caminhao;       //Preço pago base pelo reboque do veículo que está apreendido
    ...
    public:
        ...
        Caminhao(const std::string &os, const std::string &solicitacao, const std::string &funcionario,
                 ...
                 int retrovisores, int carroceria, bool eixoTraseiro, bool cintas, int suspCabine, bool extintor,
        ...
        double get_diariaCaminhao() const;
        void set_diariaCaminhao(double diariaCaminhao);
        double get_reboqueCaminhao() const;
        void set_reboqueCaminhao(double reboqueCaminhao);
