...
namespace model {
    ...
    public:
        ...
        Caminhao(int os, int id_patio, const std::string &solicitacao, const std::string &funcionario,
        ...
        //Realiza o cálculo de orçamento de veículos do tipo Caminhão, recebendo como parâmetro a data de liberação
