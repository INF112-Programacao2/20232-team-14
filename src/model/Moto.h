...
namespace model {
    ...
    private:
        ...
        double _diaria_moto;            //Preço pago a cada dia que o veículo permanece no pátio
        double _reboque_moto;           //Preço pago base pelo reboque do veículo que está apreendido
    ...
    public:
        ...
        double get_diariaMoto() const;
        void set_diariaMoto(double diariaMoto);
        double get_reboqueMoto() const;
        void set_reboqueMoto(double reboqueMoto);
        //end of autogenerated getters and setters

        //double calcOrcamento() override;
