...
namespace model {
    ...
    public:
        ...
        //Realiza o cálculo de orçamento de veículos do tipo Moto, recebendo como parâmetro a data de liberação
        virtual double calcOrcamento(std::string data_liberacao_desejado) override;

        /*Map de veículos do tipo Carro que faz a "junção" de dados específicos do tipo Moto com os gerais*/
        ...
        void updateVeiculo(std::unordered_map<std::string, std::string> &dados_veiculo, std::unordered_map<std::string, std::string> &dados_especificos) override;
